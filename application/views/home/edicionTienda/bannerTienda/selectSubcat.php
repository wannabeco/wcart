...
<select tabindex="2" autocomplete="off" id="idSubcategoria" name="idSubcategoria" class="form-control" onchange="angular.element(document.getElementById('formulario')).scope().getProductos('')">
	<option value=""></option>
