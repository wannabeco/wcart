...
<div id="modalFoto" class="modal fade" role="dialog"  data-keyboard="false" data-backdrop="static">
        ...
        <div class="modal-content" id="modalCrea">
            <form role="form"  id="formFotoPerfil" ng-submit="cambioFotoPerfil()" enctype="multipart/form-data">    
                <div class="modal-header">
                  ...
                  <h2 class="modal-title">CAMBIAR FOTO DE LA TIENDA</h2>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                ...
                Editar información de tu tienda
    ...
    <div class="row">
        <div class="col col-lg-6 col-md-6">
            <h3 class="text-left">DATOS DE LA TIENDA</h3>
            <div class="row">
        ...
        <div class="col col-lg-6 col-md-6">
            <h3 class="text-center">FOTOS DE LA TIENDA</h3>
             <div class="row">
                 <div class="col col-lg-6">
                      <div class="row-picture" style="margin:10% 0 0 0">
                      <a data-toggle="modal" data-target="#modalFoto" style="cursor: pointer">
                          <?php if($datos['logoTienda'] != ""){ ?>
                          <center>
                              <div style="box-shadow:inset 0px 0px 3px #999;border:1px solid #999;border-radius:200px;width:150px;height:150px;background: url(<?php echo base_url()."assets/uploads/files/".$datos['idTienda']."/".$datos['logoTienda'] ?>) no-repeat center center;background-size:120% "></div>
                              <!--<img class="img img-circle" id="miniatura" src="<?php echo base_url()."assets/uploads/files/".$datos['idTienda']."/".$datos['logoTienda'] ?>" alt="icon" width="35%">-->
                          </center><br><br>
                        <?php }else{ ?>
                  ...
                  <div class="col col-lg-6">
                        <div class="row-picture" style="margin:10% 0 0 0">
                        <a data-toggle="modal" data-target="#modalFoto" style="cursor: pointer">
                            <?php if($datos['bannerTienda'] != ""){ ?>
                            <center>
                                <div style="box-shadow:inset 0px 0px 3px #999;border:1px solid #999;width:100%x;height:150px;background: url(<?php echo base_url()."assets/uploads/files/".$datos['idTienda']."/".$datos['bannerTienda'] ?>) no-repeat center center;background-size:120% "></div>
                                <!--<img class="img img-circle" id="miniatura" src="<?php echo base_url()."assets/uploads/files/".$datos['idTienda']."/".$datos['bannerTienda'] ?>" alt="icon" width="35%">-->
                            </center><br><br>
                          <?php }else{ ?>
                                <center><img class="img img-circle" id="miniatura" src="<?php echo base_url()."res/img/user.jpg" ?>" alt="icon" width="25%"></center><br><br>
                          <?php } ?>
