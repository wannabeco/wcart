<div class="container">
    ...
    <div class="container text-center" style="margin-top:8%">
        <h2 class="form-signin-heading"><?php echo lang("tituloRegistroEmp") ?></h2>
        <small class="text-muted"><?php echo lang("regE_textoBienvenida") ?></small><br><br>
        <form class="form-registro bs-component" id="formRegEmpresas" role="form" ng-submit="registraEmpresa()">
        <fieldset>
        <div class="row">
          <div class="col-lg-6">
                ...
                <div class="form-group">
                  <input tabindex="2" id="direccion" name="direccion" ng-model="direccion" class="ember-view ember-text-field form-control login-input-pass" placeholder="<?php echo lang("plh_direccion_empresas") ?>" type="text">
                  <p class="help-block"><?php echo lang('txtInfo2') ?></p>
                </div>
                <div class="form-group"> 
                  <input tabindex="3" id="telefono" name="telefono" ng-model="telefono" class="ember-view ember-text-field form-control login-input-pass" placeholder="<?php echo lang("plh_telefono_empresas") ?>" type="number">
                  <p class="help-block"><?php echo lang('txtInfo3') ?></p>
                </div>
                <div class="form-group">
                  <input tabindex="4" id="email" name="email" ng-model="email" class="ember-view ember-text-field form-control login-input-pass" placeholder="<?php echo lang("plh_mail_empresas") ?>" type="email">
          ...
          <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <p class="help-block"><?php echo lang('txtInfo5') ?></p>
                </div>
                <div class="form-group">
