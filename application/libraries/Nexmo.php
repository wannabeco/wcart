...
class nexmo
{
    ...
    public static $balance_url = 'https://rest.nexmo.com/account/get-balance';
    public static $pricing_url = 'https://rest.nexmo.com/account/get-pricing/outbound';
    public static $account_url = 'https://rest.nexmo.com/account/settings';
    public static $number_url = 'https://rest.nexmo.com/account/numbers';
    public static $top_up_url = 'https://rest.nexmo.com/account/top-up';
    public static $search_url = 'https://rest.nexmo.com/number/search';
    public static $buy_url = 'https://rest.nexmo.com/number/buy';
    public static $cancel_url = 'https://rest.nexmo.com/number/cancel';
    public static $update_url = 'https://rest.nexmo.com/number/update';
    public static $message_url = 'https://rest.nexmo.com/search/message';
    public static $messages_url = 'https://rest.nexmo.com/search/messages';
    public static $rejections_url = 'https://rest.nexmo.com/search/rejections';
    public static $insight_url = 'https://rest.nexmo.com/ni';

    public static $verify_base_url = 'https://api.nexmo.com/verify';

    private $_url_array = ['balance_url', 'pricing_url', 'account_url',
    ...
    public function send_message($from, $to, $message, $type = 'text')
    {
        ...
        $params = array_merge(['api_key' => $this->_api_key, 'api_secret' => $this->_api_secret], $post);
     ...
     * return json or xml
     */
    public function get_number_update($country_code = 'TW', $msisdn = null, $params = [])
    {
        if (!isset($msisdn)) {
            echo('msisdn must be required');
            exit();
     ...
     * return json or xml
     */
    public function search_messages($ids = [], $date = null, $to = null)
    {
        $options = [
            CURLOPT_HTTPHEADER => ["Accept: application/" . $this->_format],
        ];
