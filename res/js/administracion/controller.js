...
project.controller('modulos', function($scope,$http,$q,constantes)
{
	...
	$scope.agregarCategoria = function()
	{
		...
		{
			constantes.alerta("Complete la información","Debe escribir el nombre de la categoría","info",function(){})
		}
		else
		{
...
project.controller('modulosProcesador', function($scope,$http,$q,constantes)
{
	$scope.config 			=  configLogin; //configuración global
